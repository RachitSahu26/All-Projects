...
const UserProfile = ({ toggleMenu }) => {
  ...
  return (
    <LayOut>
      ...
      <div className="flex justify-center items-center flex-col border-2 border-yellow-500 p-4">
        ...
        <div className="mt-2 border-2 border-gray-400 p-5 rounded-lg">
          ...
          <p className="text-lg font-bold">Role: {auth?.user?.role}</p>
